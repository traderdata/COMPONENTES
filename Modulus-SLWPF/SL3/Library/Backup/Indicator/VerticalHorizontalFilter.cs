...
namespace ModulusFE
{
    public static partial class StockChartX_IndicatorsParameters
    {
        internal static void Register_VerticalHorizontalFilter()
        {
            ...
            */
            RegisterIndicatorParameters(IndicatorType.VerticalHorizontalFilter, typeof(VerticalHorizontalFilter),
...
namespace ModulusFE.Indicators
{
    ...
    public class VerticalHorizontalFilter : Indicator
    {
        ...
        {
            _indicatorType = IndicatorType.VerticalHorizontalFilter;
