...
namespace ModulusFE
{
    ...
    {
        internal static void Register_VariableMovingAverage()
        {
            /*  Required inputs for this indicator:
              1. paramStr0 = Source (eg "msft.close")
              2. paramInt1 = Periods (eg 14)
            */
            RegisterIndicatorParameters(IndicatorType.VariableMovingAverage, typeof(VariableMovingAverage),
...
namespace ModulusFE.Indicators
{
    ...
    public class VariableMovingAverage : Indicator
    {
        ...
        public VariableMovingAverage(string name, ChartPanel chartPanel)
            : base(name, chartPanel)
        {
            _indicatorType = IndicatorType.VariableMovingAverage;
        ...
        protected override bool TrueAction()
        {
            ...
            Recordset pInd = ta.VariableMovingAverage(pNav, pSource, paramInt1, FullName);
