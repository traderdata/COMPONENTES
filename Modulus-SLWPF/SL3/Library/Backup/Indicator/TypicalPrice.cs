...
namespace ModulusFE
{
    ...
    {
        internal static void Register_TypicalPrice()
        {
            /*  Required inputs for this indicator:
              1. paramStr0 = Symbol (eg "msft")
            */
            RegisterIndicatorParameters(IndicatorType.TypicalPrice, typeof(TypicalPrice),
                                        "Typical Price",
...
namespace ModulusFE.Indicators
{
    ...
    public class TypicalPrice : Indicator
    {
        ...
        public TypicalPrice(string name, ChartPanel chartPanel)
            : base(name, chartPanel)
        {
            _indicatorType = IndicatorType.TypicalPrice;
        ...
        protected override bool TrueAction()
        {
            ...
            Recordset pInd = ta.TypicalPrice(pNav, pRS, FullName);
