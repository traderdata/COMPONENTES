...
namespace ModulusFE
{
    ...
    {
        internal static void Register_GopalakrishnanRangeIndex()
        {
            ...
            */
            RegisterIndicatorParameters(IndicatorType.GopalakrishnanRangeIndex, typeof(GopalakrishnanRangeIndex),
...
namespace ModulusFE.Indicators
{
    ...
    /// </list>
    /// </remarks>
    public class GopalakrishnanRangeIndex : Indicator
    {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        public GopalakrishnanRangeIndex(string name, ChartPanel chartPanel)
            : base(name, chartPanel)
        {
            _indicatorType = IndicatorType.GopalakrishnanRangeIndex;
