...
namespace ModulusFE
{
    ...
    {
        internal static void Register_LinearRegressionIntercept()
        {
            /*  Required inputs for this indicator:
              1. paramStr0 = Source (eg "msft.close")
              2. paramInt1 = Periods (eg 14)
            */
            RegisterIndicatorParameters(IndicatorType.LinearRegressionIntercept, typeof(LinearRegressionIntercept),
...
namespace ModulusFE.Indicators
{
    ...
    public class LinearRegressionIntercept : Indicator
    {
        ...
        public LinearRegressionIntercept(string name, ChartPanel chartPanel)
            : base(name, chartPanel)
        {
            _indicatorType = IndicatorType.LinearRegressionIntercept;
        ...
        protected override bool TrueAction()
        {
            ...
            {
                AppendValue(DM.TS(n), n < paramInt1 ? null : pInd.Value("Intercept", n + 1));
            }
