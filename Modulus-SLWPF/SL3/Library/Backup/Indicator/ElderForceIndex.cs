...
namespace ModulusFE
{
    ...
    {
        internal static void Register_ElderForceIndex()
        {
            ...
            */
            RegisterIndicatorParameters(IndicatorType.ElderForceIndex, typeof(ElderForceIndex),
                                        "Elder Force Index",
...
namespace ModulusFE.Indicators
{
    ...
    public class ElderForceIndex : Indicator
    {
        ...
        public ElderForceIndex(string name, ChartPanel chartPanel)
            : base(name, chartPanel)
        {
            _indicatorType = IndicatorType.ElderForceIndex;
        ...
        protected override bool TrueAction()
        {
            ...
            Index ta = new Index();
            Recordset pInd = ta.ElderForceIndex(pRS, FullName);
