...
{
    ///<summary>
    /// Converts a valid geometry string to a <see cref="PathGeometry"/> object
    ///</summary>
    public class StringToPathGeometryConverter : IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            return null != path ? Convert(path) : null;
        }
        ...
        public object ConvertBack(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            return null != geometry ? ConvertBack(geometry) : default(string);
        }
