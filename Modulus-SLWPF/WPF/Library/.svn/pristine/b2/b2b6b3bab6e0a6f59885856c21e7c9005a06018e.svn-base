...
namespace ModulusFE
{
    ...
    {
        internal static void Register_LinearRegressionSlope()
        {
            /*  Required inputs for this indicator:
              1. paramStr0 = Source (eg "msft.close")
              2. paramInt1 = Periods (eg 14)
            */
            RegisterIndicatorParameters(IndicatorType.LinearRegressionSlope, typeof(LinearRegressionSlope),
...
namespace ModulusFE.Indicators
{
    ...
    public class LinearRegressionSlope : Indicator
    {
        ...
        public LinearRegressionSlope(string name, ChartPanel chartPanel)
            : base(name, chartPanel)
        {
            _indicatorType = IndicatorType.LinearRegressionSlope;
        ...
        protected override bool TrueAction()
        {
            ...
            {
                AppendValue(DM.TS(n), n < paramInt1 ? null : pInd.Value("Slope", n + 1));
            }
