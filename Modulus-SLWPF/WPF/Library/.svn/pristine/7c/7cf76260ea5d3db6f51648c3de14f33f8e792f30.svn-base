...
namespace ModulusFE
{
    ...
    public partial class Series : INotifyPropertyChanged
    {
        ...
        public delegate void EditSerieHandler(Series serie);

        /// <summary>Evento disparado quando a ação de editar a serie é executado.</summary>
        public event EditSerieHandler EditSerieInChartPanel;

        public void FireEditSerie(Series serie)
        {
            if (EditSerieInChartPanel != null)
                EditSerieInChartPanel(serie);
        }
        //Fim
