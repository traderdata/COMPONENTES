...
namespace ModulusFE
{
    ...
    {
        internal static void Register_TriangularMovingAverage()
        {
            /*  Required inputs for this indicator:
              1. paramStr0 = Source (eg "msft.close")
              2. paramInt1 = Periods (eg 14)
            */
            RegisterIndicatorParameters(IndicatorType.TriangularMovingAverage, typeof(TriangularMovingAverage),
...
namespace ModulusFE.Indicators
{
    ...
    public class TriangularMovingAverage : Indicator
    {
        ...
        public TriangularMovingAverage(string name, ChartPanel chartPanel)
            : base(name, chartPanel)
        {
            _indicatorType = IndicatorType.TriangularMovingAverage;
        ...
        protected override bool TrueAction()
        {
            ...
            Recordset pInd = ta.TriangularMovingAverage(pNav, pSource, paramInt1, FullName);
