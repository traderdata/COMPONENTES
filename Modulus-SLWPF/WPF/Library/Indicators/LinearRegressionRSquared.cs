...
namespace ModulusFE
{
    ...
    {
        internal static void Register_LinearRegressionRSquared()
        {
            /*  Required inputs for this indicator:
              1. paramStr0 = Source (eg "msft.close")
              2. paramInt1 = Periods (eg 14)
            */
            RegisterIndicatorParameters(IndicatorType.LinearRegressionRSquared, typeof(LinearRegressionRSquared),
...
namespace ModulusFE.Indicators
{
    ...
    public class LinearRegressionRSquared : Indicator
    {
        ...
        public LinearRegressionRSquared(string name, ChartPanel chartPanel)
            : base(name, chartPanel)
        {
            _indicatorType = IndicatorType.LinearRegressionRSquared;
