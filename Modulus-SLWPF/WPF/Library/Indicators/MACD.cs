...
namespace ModulusFE
{
    ...
    {
        internal static void Register_MACD()
        {
            RegisterIndicatorParameters(IndicatorType.MACD, typeof(MACD),
                                        "MACD",
...
namespace ModulusFE.Indicators
{
    ...
    public class MACD : Indicator
    {
        ...
        public MACD(string name, ChartPanel chartPanel)
            : base(name, chartPanel)
        {
            _indicatorType = IndicatorType.MACD;
