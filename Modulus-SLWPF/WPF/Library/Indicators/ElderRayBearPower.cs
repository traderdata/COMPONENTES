...
namespace ModulusFE
{
    ...
    {
        internal static void Register_ElderRayBearPower()
        {
            ...
            */
            RegisterIndicatorParameters(IndicatorType.ElderRayBearPower, typeof(ElderRayBearPower),
...
namespace ModulusFE.Indicators
{
    ...
    /// </list>
    /// </remarks>
    public class ElderRayBearPower : Indicator
    {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        public ElderRayBearPower(string name, ChartPanel chartPanel)
